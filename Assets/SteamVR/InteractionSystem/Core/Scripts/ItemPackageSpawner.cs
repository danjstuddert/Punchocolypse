    ...
    public class ItemPackageSpawner : Hoverable
    {
        ...
        private void CreatePreviewObject()
        {
            ...
            if (useItemPackagePreview)
            {
                ...
                { // if we don't have a spawned item out there, use the regular preview
                ...
                { // there's a spawned item out there. Use the faded preview
        ...
        public override void HandHoverUpdate(Hand hand)
        {
            ...
            if (requireTriggerPressToTake && justPickedUpItem == false)
                if (hand.controller != null && hand.controller.GetHairTriggerDown())
                    SpawnAndAttachObject(hand);
        }
        ...
        public override void OnHandHoverEnd(Hand hand)
        {
            ...
            if(takeBackItem && justPickedUpItem)
