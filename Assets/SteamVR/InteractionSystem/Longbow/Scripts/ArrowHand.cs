...
namespace Valve.VR.InteractionSystem
{
    ...
    public class ArrowHand : Hoverable
    {
        ...
        public GameObject CurrentArrow { get { return currentArrow; } }
        ...
        public override void OnAttachedToHand(Hand attachedHand)
        {
            ...
            if (attachedHand.startingHandType == Hand.HandType.Left)
        ...
        private void FireArrow(float arrowVelocity, Vector3 arrowDirection)
        {
            ...
            if(bow.gameObject.activeInHierarchy && bow.Nocked)
                bow.ArrowReleased();
