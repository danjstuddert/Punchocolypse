...
public class Quiver : MonoBehaviour
{
    ...
    [SerializeField] private float outOfQuiverDelay;
    [SerializeField] private SoundPlayOneshot arrowDrawnSound;
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        {
            this.Invoke(ArrowHandOut, outOfQuiverDelay);
            hasPulsed = false;
        }
